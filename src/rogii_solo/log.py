...
class Log(ComplexObject):
    """
    Represents a :class:`Log` within a :class:`~rogii_ssolo.well.Well`, containing log data and related operations.
...
class LogPoint(BaseObject):
    """
    Represents an individual :class:`LogPoint` containing measured depth (MD) and log value.
