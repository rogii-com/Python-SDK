...
class Horizon(BaseObject):
    """
    Represents a :class:`Horizon` within an :class:`~rogii_solo.interpretation.Interpretation`, providing access
    ...
    def __init__(self, interpretation: 'rogii_solo.interpretation.Interpretation', **kwargs):
        ...
        """Represents the :class:`~rogii_solo.interpretation.Interpretation` of the :class:`Horizon`"""
    ...
    def to_dict(self) -> Dict:
        """
        Converts the :class:`Horizon` instance to a dictionary.
    ...
    def to_df(self) -> DataFrame:
        """
        Converts the :class:`Horizon` instance to a Pandas DataFrame.
...
class HorizonPoint(BaseObject):
    """
    Represents an individual point on a :class:`Horizon`, storing the measured depth (MD)
    ...
    def to_dict(self, get_converted: bool = True) -> Dict:
        """
        Converts the :class:`HorizonPoint` instance to a dictionary, optionally
    ...
    def to_df(self, get_converted: bool = True) -> DataFrame:
        """
        Converts the :class:`HorizonPoint` instance to a Pandas DataFrame,
