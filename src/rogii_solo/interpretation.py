...
class Interpretation(ComplexObject):
    """
    Represents an :class:`Interpretation` for a :class:`~rogii_solo.well.Well`, containing data
    ...
    def to_dict(self, get_converted: bool = True) -> Dict[str, Any]:
        """
        Converts the :class:`Interpretation` instance to a dictionary.
    ...
    def to_df(self, get_converted: bool = True) -> InterpretationType:
        """
        Converts the :class:`Interpretation` to a dictionary with Pandas DataFrames.
